...
"Host": "newscatcher.p.rapidapi.com"
    ...
    fetch(`https://newsdata.io/api/1/latest?apikey=pub_464098b016547fa68e21449555d8173f9a014&q=${this.props.genre}&language=en`,params
    )
      ...
      this.state.article.forEach((e, x) => {
        ...
        items.push(
          <NewsItem
            ...
            url={e.link}
            publisher={e.source_id.slice(0,-3)[e.source_id.slice(0,-3).length-1]==="."?e.source_id.slice(0,-4):e.source_id.slice(0,-3)}
          />
        );
      ...
      <div>
        <h1
          ...
          style={{
            ...
            fontFamily: "serif",
            background:
              "-webkit-linear-gradient(45deg,rgb(0,110,225), rgb(255,31,1))",
        ...
        <>
          <InfiniteScroll
            ...
            loader={<div style={{width: "90%", overflow: "hidden"}}><ClipLoader color={"white"} loading={this.state.loading} cssOverride={this.styleSpinner} size={80} /></div>}
            endMessage={<div style={{width: "90%", overflow: "hidden"}}><ClipLoader color={"white"} loading={this.state.loading} cssOverride={this.styleSpinner} size={50} /></div>
            }
          >
          {/* {items} */}
          <div
